## Note: Because Swift Standard Library now has Codable, this project is archived.
...
### See the [Data Modeler-Code Generation Docs](Docs/CodegenGuide.md) for more information.
